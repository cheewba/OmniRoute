...
COPY --from=builder /app/scripts/dev/standalone-server-ws.mjs ./dev/standalone-server-ws.mjs
COPY --from=builder /app/scripts/dev/responses-ws-proxy.mjs ./dev/responses-ws-proxy.mjs
